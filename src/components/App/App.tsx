...
const KodixApp: React.FC<Props> = ({ appName, appDescription }) => {
	return (
		...
		<div className="bg-gray-700 font-semibold text-center rounded-3xl shadow-xl p-5 max-w-sm">
			...
			<button className="hover:bg-gray-600 px-8 py-2 mt-8 rounded-3xl text-gray-100 font-semibold uppercase tracking-wide">Install (not yet implemented)</button>
		</div>
